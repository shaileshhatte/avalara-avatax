...
exports.convertSchemaToJson = void 0;
 ...
 */
function convertSchemaToJson(model, generateFullModel, onlyModel) {
    ...
    const propertiesObject = schemaModel.properties || null;
    if (propertiesObject !== null) {
        const props = Object.keys(propertiesObject);
        props.forEach((propKey) => {
            // console.log(`prop ${prop}`);
            const propObject = propertiesObject[propKey];
...
exports.convertSchemaToJson = convertSchemaToJson;
/**
...
//# sourceMappingURL=requestJsonGenerator.js.map